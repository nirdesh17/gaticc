...
static std::set<std::string> megablock_tbl{
    ...
    "Gemm",        "QLinearEltwise", "NonMaxSuppression", "NoOp", "Transpose", "QLinearSigmoid", "QLinearConcat","Resize"};
...
int Op::Layer::QLinearEltwise::get_inst(InstBlob &blob, AddressGen &gen,
  ...
  gen_eltwise_input_quant(this, add_inst, this->a_scale, this->b_scale,
                          this->a_zp, this->b_zp);

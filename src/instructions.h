...
#define OutputBlock_ImageDimAcc_HIGH 144
...
// ns is disabled
#define OutputBlock_AccEn_LOW 145
#define OutputBlock_AccEn_HIGH 145
#define OutputBlock_AccEn_COUNT 1
// If this layer's output is supposed to be sent back to the CP
// U, this flag is set
#define OutputBlock_DispatchEn_LOW 146
#define OutputBlock_DispatchEn_HIGH 146
...
#define OutputBlock_DispatchID_LOW 147
#define OutputBlock_DispatchID_HIGH 178
...
// that bit.
#define OutputBlock_OnChipAcc_LOW 179
#define OutputBlock_OnChipAcc_HIGH 179
#define OutputBlock_OnChipAcc_COUNT 1
#define OutputBlock_OH_LOW 180
#define OutputBlock_OH_HIGH 189
#define OutputBlock_OH_COUNT 10
#define OutputBlock_OW_LOW 190
#define OutputBlock_OW_HIGH 199
#define OutputBlock_OW_COUNT 10
// If 1, treat outputs from the megablock as flat bytes, not as
//  aligned bytes with zeros in it
#define OutputBlock_FlatController_LOW 200
#define OutputBlock_FlatController_HIGH 200
#define OutputBlock_FlatController_COUNT 1
#define OutputBlock_OpWidth_LOW 201
#define OutputBlock_OpWidth_HIGH 203
...
#define META_CONST_DISPATCH_SPI 0x000000000002

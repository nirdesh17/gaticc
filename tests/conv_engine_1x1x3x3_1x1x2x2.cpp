...
bool conv_engine_1x1x3x3_1x1x2x2() {
    ...
    bool result = generate_report<float, float>("conv_engine_1x1x3x3_1x1x2x2", output_values, expected_output_values);
    return result;
}
...
int main(int argc, char *argv[]) {
  ...
  import_array();
  if(!conv_engine_1x1x3x3_1x1x2x2())
    exit(1);

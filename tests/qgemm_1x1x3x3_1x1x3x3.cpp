...
bool qgemm_1x1x3x3_1x1x3x3() {
    ...
    std::vector<int32_t> bias_values(bias_dims[0] * bias_dims[1], 0);
    bias_proto.mutable_raw_data()->append(reinterpret_cast<const char*>(bias_values.data()), bias_values.size() * sizeof(int32_t));

...
bool conv_engine_1x3x3x3_3x3x2x2() {
    ...
    Op::ConvParams conv_params={3,{2, 2},{0,0,0,0},{1,1},{0, 0}}; 
    ...
    bool result = generate_report<float, float>("conv_engine_1x3x3x3_3x3x2x2", output_values, expected_output_values);
    return result;
}
...
int main(int argc, char *argv[]) {
  ...
  import_array();
  if(!conv_engine_1x3x3x3_3x3x2x2())
    exit(1);

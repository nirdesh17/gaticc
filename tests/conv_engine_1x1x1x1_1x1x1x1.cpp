...
bool conv_engine_1x1x3x3_1x1x1x1() {
    ...
    Op::ConvParams conv_params={1,{1, 1},{0,0,0,0},{1,1},{0, 0}};
    ...
    bool result = generate_report<float, float>("conv_engine_1x1x3x3_1x1x1x1", output_values, expected_output_values);
    return result;
}
...
int main(int argc, char *argv[]) {
  ...
  import_array();
  if(!conv_engine_1x1x3x3_1x1x1x1())
    exit(1);
